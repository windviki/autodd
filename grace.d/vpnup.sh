...
route add -host 107.20.168.142 gw $VPNGW
route add -host 108.61.5.3 gw $VPNGW
route add -host 109.104.79.84 gw $VPNGW
route add -host 109.201.135.85 gw $VPNGW
route add -host 109.239.54.15 gw $VPNGW
route add -host 109.74.247.136 gw $VPNGW
route add -host 112.104.158.240 gw $VPNGW
...
route add -host 174.35.39.20 gw $VPNGW
route add -host 174.35.40.46 gw $VPNGW
...
route add -host 176.32.94.97 gw $VPNGW
...
route add -host 180.233.112.124 gw $VPNGW
...
route add -host 184.168.63.54 gw $VPNGW
...
route add -host 184.26.101.135 gw $VPNGW
...
route add -host 192.221.123.252 gw $VPNGW
...
route add -host 2.23.149.50 gw $VPNGW
...
route add -host 209.190.85.35 gw $VPNGW
...
route add -host 209.51.164.60 gw $VPNGW
...
route add -host 249.129.46.48 gw $VPNGW
route add -host 27.98.194.51 gw $VPNGW
...
route add -host 4.27.12.253 gw $VPNGW
route add -host 4.28.16.34 gw $VPNGW
...
route add -host 54.76.135.1 gw $VPNGW
...
route add -host 69.55.51.70 gw $VPNGW
...
route add -host 78.46.230.81 gw $VPNGW
...
route add -host 8.27.235.126 gw $VPNGW
route add -host 8.27.248.125 gw $VPNGW
route add -host 8.27.252.253 gw $VPNGW
...
route add -host 85.17.147.39 gw $VPNGW
...
route add -host 85.17.72.230 gw $VPNGW
...
route add -host 88.80.16.63 gw $VPNGW
...
route add -net 203.106.50.0/24 gw $VPNGW
...
route add -net 62.41.10.0/24 gw $VPNGW
route add -net 63.233.126.0/24 gw $VPNGW
route add -net 63.251.171.0/24 gw $VPNGW
route add -net 63.80.138.0/24 gw $VPNGW
route add -net 64.209.21.0/24 gw $VPNGW
