...
route add -host 107.20.132.140 gw $VPNGW
route add -host 107.20.168.139 gw $VPNGW
...
route add -host 110.45.152.70 gw $VPNGW
...
route add -host 121.254.154.140 gw $VPNGW
...
route add -host 123.204.98.3 gw $VPNGW
...
route add -host 124.9.0.71 gw $VPNGW
route add -host 124.9.13.21 gw $VPNGW
route add -host 125.114.115.246 gw $VPNGW
...
route add -host 159.253.176.37 gw $VPNGW
...
route add -host 173.244.207.23 gw $VPNGW
...
route add -host 184.105.135.195 gw $VPNGW
...
route add -host 184.31.37.50 gw $VPNGW
route add -host 184.31.44.79 gw $VPNGW
route add -host 184.72.221.111 gw $VPNGW
route add -host 184.72.246.159 gw $VPNGW
route add -host 184.73.126.211 gw $VPNGW
...
route add -host 199.27.134.88 gw $VPNGW
...
route add -host 204.152.254.12 gw $VPNGW
route add -host 204.160.103.126 gw $VPNGW
route add -host 204.236.138.186 gw $VPNGW
...
route add -host 208.87.35.100 gw $VPNGW
...
route add -host 209.62.105.16 gw $VPNGW
...
route add -host 31.222.68.37 gw $VPNGW
...
route add -host 4.28.128.218 gw $VPNGW
route add -host 4.30.24.202 gw $VPNGW
...
route add -host 50.18.114.60 gw $VPNGW
route add -host 50.19.122.222 gw $VPNGW
route add -host 50.19.123.115 gw $VPNGW
...
route add -host 64.95.64.197 gw $VPNGW
...
route add -host 67.220.90.30 gw $VPNGW
...
route add -host 69.171.224.11 gw $VPNGW
...
route add -host 70.29.68.103 gw $VPNGW
...
route add -host 76.74.255.117 gw $VPNGW
...
route add -host 85.17.147.40 gw $VPNGW
...
route add -host 91.202.61.172 gw $VPNGW
...
route add -net 173.245.70.0/24 gw $VPNGW
...
route add -net 64.212.198.0/24 gw $VPNGW
...
route add -net 69.171.229.0/24 gw $VPNGW
