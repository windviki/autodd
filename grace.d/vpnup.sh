...
route add -host 123.204.0.223 gw $VPNGW
...
route add -host 174.35.52.139 gw $VPNGW
...
route add -host 184.72.223.204 gw $VPNGW
...
route add -host 202.106.1.2 gw $VPNGW
...
route add -host 202.181.7.85 gw $VPNGW
...
route add -host 204.45.86.107 gw $VPNGW
...
route add -host 216.218.207.155 gw $VPNGW
...
route add -host 61.219.96.237 gw $VPNGW
...
route add -host 66.114.48.42 gw $VPNGW
...
route add -host 74.125.77.121 gw $VPNGW
...
route add -host 88.221.181.50 gw $VPNGW
...
route add -host 92.123.196.79 gw $VPNGW
...
route add -host 96.46.5.178 gw $VPNGW
...
route add -net 74.125.155.0/24 gw $VPNGW
route add -net 74.125.19.0/24 gw $VPNGW
...
route add -net 80.239.201.0/24 gw $VPNGW
...
route add -net 92.123.154.0/24 gw $VPNGW
