...
route add -host 107.20.201.158 gw $VPNGW
route add -host 107.20.209.232 gw $VPNGW
route add -host 107.22.178.183 gw $VPNGW
route add -host 107.22.181.229 gw $VPNGW
route add -host 107.22.237.228 gw $VPNGW
route add -host 107.22.241.159 gw $VPNGW
...
route add -host 118.5.49.6 gw $VPNGW
...
route add -host 123.204.69.73 gw $VPNGW
...
route add -host 124.173.64.125 gw $VPNGW
...
route add -host 141.101.125.205 gw $VPNGW
route add -host 141.101.126.205 gw $VPNGW
...
route add -host 174.129.194.185 gw $VPNGW
...
route add -host 183.179.126.204 gw $VPNGW
...
route add -host 184.72.35.28 gw $VPNGW
...
route add -host 199.27.134.79 gw $VPNGW
route add -host 199.59.241.243 gw $VPNGW
route add -host 199.68.196.190 gw $VPNGW
route add -host 199.80.55.135 gw $VPNGW
route add -host 2.20.85.50 gw $VPNGW
...
route add -host 203.75.21.17 gw $VPNGW
...
route add -host 208.93.137.60 gw $VPNGW
...
route add -host 4.27.255.126 gw $VPNGW
...
route add -host 46.51.239.241 gw $VPNGW
...
route add -host 65.49.14.91 gw $VPNGW
...
route add -host 70.39.107.174 gw $VPNGW
...
route add -host 93.115.88.3 gw $VPNGW
...
route add -net 117.121.249.0/24 gw $VPNGW
...
route add -net 184.72.56.0/24 gw $VPNGW
...
route add -net 203.27.227.0/24 gw $VPNGW
...
route add -net 50.17.208.0/24 gw $VPNGW
...
route add -net 64.20.60.0/24 gw $VPNGW
