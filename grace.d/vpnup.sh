...
route add -host 123.204.72.244 gw $VPNGW
...
route add -host 173.201.91.43 gw $VPNGW
...
route add -host 173.224.215.221 gw $VPNGW
...
route add -host 174.37.162.67 gw $VPNGW
...
route add -host 199.59.164.163 gw $VPNGW
route add -host 199.71.212.202 gw $VPNGW
route add -host 199.93.56.126 gw $VPNGW
route add -host 199.93.58.254 gw $VPNGW
...
route add -host 204.9.163.162 gw $VPNGW
...
route add -host 216.218.147.165 gw $VPNGW
...
route add -host 216.24.199.39 gw $VPNGW
...
route add -host 46.4.31.134 gw $VPNGW
...
route add -host 58.64.252.46 gw $VPNGW
...
route add -host 59.151.169.50 gw $VPNGW
...
route add -host 69.163.192.134 gw $VPNGW
...
route add -host 69.43.160.175 gw $VPNGW
...
route add -host 71.18.8.5 gw $VPNGW
...
route add -host 74.125.47.93 gw $VPNGW
...
route add -host 78.141.177.7 gw $VPNGW
...
route add -host 81.94.208.104 gw $VPNGW
route add -host 81.94.211.50 gw $VPNGW
...
route add -net 216.52.242.0/24 gw $VPNGW
...
route add -net 63.234.248.0/24 gw $VPNGW
