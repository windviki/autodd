...
route add -host 128.242.240.52 gw $VPNGW
route add -host 128.242.245.212 gw $VPNGW
...
route add -host 168.143.161.20 gw $VPNGW
...
route add -host 212.58.244.64 gw $VPNGW
...
route add -host 46.82.174.68 gw $VPNGW
...
route add -host 63.135.80.79 gw $VPNGW
...
route add -host 69.192.149.50 gw $VPNGW
...
route add -host 74.125.47.121 gw $VPNGW
...
route add -net 208.94.2.0/24 gw $VPNGW
...
route add -net 218.32.86.0/24 gw $VPNGW
...
route add -net 61.219.96.0/24 gw $VPNGW
...
route add -net 63.234.226.0/24 gw $VPNGW
