...
route add -host 123.204.64.203 gw $VPNGW
...
route add -host 174.35.52.142 gw $VPNGW
...
route add -host 202.153.118.194 gw $VPNGW
...
route add -host 209.236.75.117 gw $VPNGW
...
route add -host 66.114.48.35 gw $VPNGW
...
route add -host 66.220.147.44 gw $VPNGW
...
route add -host 66.90.103.41 gw $VPNGW
...
route add -host 74.125.113.121 gw $VPNGW
...
route add -host 85.114.136.243 gw $VPNGW
...
route add -host 96.16.76.79 gw $VPNGW
...
route add -net 208.50.77.0/24 gw $VPNGW
...
route add -net 84.53.134.0/24 gw $VPNGW
