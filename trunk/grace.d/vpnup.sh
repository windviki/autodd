...
route add -host 107.20.156.155 gw $VPNGW
route add -host 107.20.178.167 gw $VPNGW
route add -host 107.21.211.22 gw $VPNGW
...
route add -host 110.45.152.74 gw $VPNGW
...
route add -host 141.8.224.106 gw $VPNGW
route add -host 146.82.200.125 gw $VPNGW
route add -host 149.174.97.30 gw $VPNGW
route add -host 149.174.98.30 gw $VPNGW
...
route add -host 173.254.28.36 gw $VPNGW
...
route add -host 184.169.156.4 gw $VPNGW
...
route add -host 184.73.195.6 gw $VPNGW
route add -host 184.73.205.235 gw $VPNGW
...
route add -host 199.59.150.39 gw $VPNGW
route add -host 199.59.166.98 gw $VPNGW
route add -host 199.59.241.227 gw $VPNGW
...
route add -host 203.106.50.35 gw $VPNGW
...
route add -host 204.236.224.188 gw $VPNGW
...
route add -host 208.43.167.112 gw $VPNGW
...
route add -host 23.45.21.50 gw $VPNGW
...
route add -host 50.16.215.20 gw $VPNGW
route add -host 50.16.233.102 gw $VPNGW
route add -host 50.17.208.4 gw $VPNGW
route add -host 50.18.171.55 gw $VPNGW
route add -host 50.18.39.83 gw $VPNGW
...
route add -host 50.97.219.34 gw $VPNGW
...
route add -host 64.209.21.31 gw $VPNGW
...
route add -host 66.175.123.34 gw $VPNGW
...
route add -host 69.171.224.37 gw $VPNGW
...
route add -host 69.175.29.66 gw $VPNGW
...
route add -host 79.129.203.18 gw $VPNGW
...
route add -host 88.80.2.32 gw $VPNGW
...
route add -net 119.161.24.0/24 gw $VPNGW
route add -net 123.242.227.0/24 gw $VPNGW
route add -net 123.242.230.0/24 gw $VPNGW
route add -net 124.40.41.0/24 gw $VPNGW
route add -net 125.56.200.0/24 gw $VPNGW
...
route add -net 24.143.196.0/24 gw $VPNGW
...
route add -net 64.208.5.0/24 gw $VPNGW
