...
route add -host 112.104.167.246 gw $VPNGW
...
route add -host 174.129.200.225 gw $VPNGW
...
route add -host 174.36.45.48 gw $VPNGW
...
route add -host 182.50.148.128 gw $VPNGW
...
route add -host 184.168.36.70 gw $VPNGW
...
route add -host 184.50.37.50 gw $VPNGW
...
route add -host 203.80.87.17 gw $VPNGW
...
route add -host 205.185.121.43 gw $VPNGW
...
route add -host 4.23.42.126 gw $VPNGW
...
route add -host 46.51.250.245 gw $VPNGW
...
route add -host 50.19.102.238 gw $VPNGW
...
route add -host 69.171.229.13 gw $VPNGW
...
route add -host 70.29.57.205 gw $VPNGW
...
route add -host 8.12.217.126 gw $VPNGW
...
route add -host 8.27.253.125 gw $VPNGW
...
route add -host 85.17.216.46 gw $VPNGW
...
route add -host 91.203.99.60 gw $VPNGW
...
route add -net 117.104.135.0/24 gw $VPNGW
...
route add -net 204.201.160.0/24 gw $VPNGW
...
route add -net 216.39.58.0/24 gw $VPNGW
