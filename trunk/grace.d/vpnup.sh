...
route add -host 119.246.134.161 gw $VPNGW
route add -host 119.246.26.17 gw $VPNGW
route add -host 119.247.151.166 gw $VPNGW
route add -host 119.247.2.231 gw $VPNGW
...
route add -host 159.106.121.75 gw $VPNGW
route add -host 163.29.3.40 gw $VPNGW
route add -host 168.143.113.10 gw $VPNGW
route add -host 168.143.171.84 gw $VPNGW
...
route add -host 173.224.216.174 gw $VPNGW
...
route add -host 174.129.221.183 gw $VPNGW
...
route add -host 174.36.61.146 gw $VPNGW
...
route add -host 198.78.193.126 gw $VPNGW
...
route add -host 202.55.227.70 gw $VPNGW
...
route add -host 203.69.42.41 gw $VPNGW
...
route add -host 205.188.100.11 gw $VPNGW
...
route add -host 206.33.49.126 gw $VPNGW
...
route add -host 208.115.241.119 gw $VPNGW
...
route add -host 208.94.2.106 gw $VPNGW
...
route add -host 213.205.32.56 gw $VPNGW
...
route add -host 218.83.175.155 gw $VPNGW
...
route add -host 58.176.78.91 gw $VPNGW
route add -host 58.64.135.100 gw $VPNGW
...
route add -host 59.120.159.55 gw $VPNGW
...
route add -host 60.199.244.131 gw $VPNGW
...
route add -host 61.92.183.87 gw $VPNGW
...
route add -host 63.135.80.84 gw $VPNGW
...
route add -host 65.55.123.220 gw $VPNGW
route add -host 65.60.9.34 gw $VPNGW
route add -host 66.114.50.81 gw $VPNGW
route add -host 66.114.51.28 gw $VPNGW
...
route add -host 66.220.146.11 gw $VPNGW
...
route add -host 66.96.216.168 gw $VPNGW
...
route add -host 67.215.65.132 gw $VPNGW
route add -host 67.215.66.132 gw $VPNGW
...
route add -host 69.192.44.79 gw $VPNGW
...
route add -host 93.184.220.20 gw $VPNGW
...
route add -host 99.231.29.189 gw $VPNGW
...
route add -net 122.147.63.0/24 gw $VPNGW
...
route add -net 168.143.241.0/24 gw $VPNGW
...
route add -net 204.2.166.0/24 gw $VPNGW
...
route add -net 209.170.90.0/24 gw $VPNGW
