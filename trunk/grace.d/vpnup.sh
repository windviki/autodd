...
route add -host 123.204.7.155 gw $VPNGW
...
route add -host 173.224.215.222 gw $VPNGW
...
route add -host 184.72.37.90 gw $VPNGW
...
route add -host 199.27.134.101 gw $VPNGW
route add -host 199.27.135.101 gw $VPNGW
...
route add -host 207.66.182.14 gw $VPNGW
...
route add -host 216.8.179.24 gw $VPNGW
...
route add -host 219.67.15.109 gw $VPNGW
...
route add -host 58.64.180.135 gw $VPNGW
...
route add -host 66.114.53.25 gw $VPNGW
...
route add -host 66.96.224.89 gw $VPNGW
...
route add -host 68.232.188.42 gw $VPNGW
...
route add -host 82.197.130.148 gw $VPNGW
