...
route add -host 123.204.69.160 gw $VPNGW
...
route add -host 168.143.162.68 gw $VPNGW
route add -host 168.143.171.180 gw $VPNGW
...
route add -host 204.244.167.198 gw $VPNGW
...
route add -host 208.94.2.88 gw $VPNGW
...
route add -host 66.220.153.19 gw $VPNGW
...
route add -host 88.221.81.50 gw $VPNGW
