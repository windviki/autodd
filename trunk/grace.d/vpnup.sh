...
route add -host 106.187.97.65 gw $VPNGW
...
route add -host 107.23.22.90 gw $VPNGW
route add -host 107.23.50.156 gw $VPNGW
...
route add -host 112.104.164.85 gw $VPNGW
...
route add -host 118.244.177.79 gw $VPNGW
...
route add -host 174.129.23.118 gw $VPNGW
...
route add -host 184.31.197.50 gw $VPNGW
...
route add -host 204.246.163.150 gw $VPNGW
...
route add -host 208.177.254.37 gw $VPNGW
...
route add -host 208.87.34.15 gw $VPNGW
...
route add -host 209.177.81.30 gw $VPNGW
...
route add -host 23.23.118.23 gw $VPNGW
route add -host 23.23.192.105 gw $VPNGW
route add -host 23.23.210.22 gw $VPNGW
...
route add -host 31.222.74.37 gw $VPNGW
...
route add -host 50.112.135.98 gw $VPNGW
route add -host 50.112.140.46 gw $VPNGW
route add -host 50.112.141.170 gw $VPNGW
route add -host 50.112.144.148 gw $VPNGW
...
route add -host 54.243.78.80 gw $VPNGW
...
route add -host 67.221.176.194 gw $VPNGW
...
route add -host 74.86.197.160 gw $VPNGW
...
route add -net 125.56.201.0/24 gw $VPNGW
...
route add -net 14.0.37.0/24 gw $VPNGW
...
route add -net 210.155.101.0/24 gw $VPNGW
route add -net 210.242.17.0/24 gw $VPNGW
...
route add -net 50.112.147.0/24 gw $VPNGW
...
route add -net 54.240.164.0/24 gw $VPNGW
...
route add -net 66.196.66.0/24 gw $VPNGW
...
route add -net 87.248.105.0/24 gw $VPNGW
