...
route add -host 109.74.247.136 gw $VPNGW
route add -host 110.45.152.78 gw $VPNGW
...
route add -host 119.247.212.215 gw $VPNGW
...
route add -host 123.204.64.222 gw $VPNGW
route add -host 123.242.224.113 gw $VPNGW
route add -host 124.108.93.20 gw $VPNGW
...
route add -host 157.55.179.60 gw $VPNGW
...
route add -host 173.254.212.98 gw $VPNGW
...
route add -host 173.255.248.222 gw $VPNGW
...
route add -host 174.127.85.227 gw $VPNGW
...
route add -host 176.32.65.51 gw $VPNGW
...
route add -host 184.168.192.117 gw $VPNGW
...
route add -host 188.40.121.101 gw $VPNGW
...
route add -host 199.27.135.42 gw $VPNGW
route add -host 199.59.241.249 gw $VPNGW
...
route add -host 204.9.47.249 gw $VPNGW
route add -host 204.93.175.51 gw $VPNGW
route add -host 205.178.152.153 gw $VPNGW
...
route add -host 208.87.32.69 gw $VPNGW
...
route add -host 209.85.30.237 gw $VPNGW
...
route add -host 216.18.194.244 gw $VPNGW
...
route add -host 216.218.147.171 gw $VPNGW
...
route add -host 218.213.244.34 gw $VPNGW
...
route add -host 253.157.14.165 gw $VPNGW
route add -host 31.170.160.106 gw $VPNGW
...
route add -host 38.99.68.180 gw $VPNGW
...
route add -host 46.21.239.252 gw $VPNGW
...
route add -host 50.58.197.17 gw $VPNGW
route add -host 50.97.161.226 gw $VPNGW
...
route add -host 64.62.224.79 gw $VPNGW
...
route add -host 65.75.139.248 gw $VPNGW
...
route add -host 69.170.135.91 gw $VPNGW
route add -host 69.171.228.12 gw $VPNGW
...
route add -host 70.29.57.10 gw $VPNGW
...
route add -host 72.247.117.135 gw $VPNGW
...
route add -host 74.207.254.151 gw $VPNGW
...
route add -host 75.125.118.171 gw $VPNGW
...
route add -host 8.26.195.253 gw $VPNGW
route add -host 8.26.198.253 gw $VPNGW
...
route add -host 85.17.82.9 gw $VPNGW
...
route add -host 98.142.98.90 gw $VPNGW
...
route add -net 173.224.213.0/24 gw $VPNGW
...
route add -net 219.96.106.0/24 gw $VPNGW
...
route add -net 58.27.22.0/24 gw $VPNGW
route add -net 58.27.86.0/24 gw $VPNGW
...
route add -net 60.254.131.0/24 gw $VPNGW
...
route add -net 63.80.138.0/24 gw $VPNGW
route add -net 64.233.183.0/24 gw $VPNGW
...
route add -net 67.148.47.0/24 gw $VPNGW
...
route add -net 74.125.71.0/24 gw $VPNGW
...
route add -net 83.149.124.0/24 gw $VPNGW
