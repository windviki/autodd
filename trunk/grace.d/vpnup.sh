...
route add -host 107.21.106.77 gw $VPNGW
route add -host 107.21.243.42 gw $VPNGW
route add -host 107.21.7.89 gw $VPNGW
route add -host 107.23.124.152 gw $VPNGW
route add -host 107.23.17.140 gw $VPNGW
route add -host 108.160.154.214 gw $VPNGW
route add -host 108.162.197.199 gw $VPNGW
route add -host 108.162.204.135 gw $VPNGW
route add -host 108.162.207.135 gw $VPNGW
...
route add -host 108.62.192.126 gw $VPNGW
...
route add -host 119.246.26.142 gw $VPNGW
...
route add -host 123.204.26.120 gw $VPNGW
...
route add -host 141.101.125.234 gw $VPNGW
route add -host 141.101.126.74 gw $VPNGW
route add -host 141.101.127.135 gw $VPNGW
route add -host 141.8.226.2 gw $VPNGW
...
route add -host 173.252.101.16 gw $VPNGW
...
route add -host 174.139.170.148 gw $VPNGW
...
route add -host 184.168.221.83 gw $VPNGW
route add -host 184.168.229.1 gw $VPNGW
route add -host 184.168.70.179 gw $VPNGW
route add -host 184.169.156.229 gw $VPNGW
...
route add -host 198.74.117.100 gw $VPNGW
...
route add -host 199.27.75.194 gw $VPNGW
route add -host 199.58.84.76 gw $VPNGW
route add -host 199.58.86.133 gw $VPNGW
route add -host 199.59.149.231 gw $VPNGW
route add -host 199.59.160.243 gw $VPNGW
route add -host 199.59.163.213 gw $VPNGW
route add -host 199.59.241.179 gw $VPNGW
...
route add -host 203.192.162.73 gw $VPNGW
...
route add -host 207.198.113.231 gw $VPNGW
...
route add -host 209.177.86.4 gw $VPNGW
...
route add -host 211.144.85.3 gw $VPNGW
...
route add -host 216.151.210.124 gw $VPNGW
...
route add -host 216.38.192.53 gw $VPNGW
...
route add -host 217.19.237.54 gw $VPNGW
...
route add -host 23.21.103.189 gw $VPNGW
route add -host 23.21.207.156 gw $VPNGW
route add -host 23.21.241.131 gw $VPNGW
route add -host 23.21.41.90 gw $VPNGW
route add -host 23.21.75.130 gw $VPNGW
route add -host 23.23.111.137 gw $VPNGW
route add -host 23.23.192.105 gw $VPNGW
route add -host 23.23.204.240 gw $VPNGW
...
route add -host 31.222.72.39 gw $VPNGW
...
route add -host 61.200.81.136 gw $VPNGW
...
route add -host 66.220.158.16 gw $VPNGW
...
route add -host 68.178.232.100 gw $VPNGW
...
route add -net 108.162.205.0/24 gw $VPNGW
route add -net 108.162.206.0/24 gw $VPNGW
...
route add -net 120.29.145.0/24 gw $VPNGW
...
route add -net 157.166.240.0/24 gw $VPNGW
route add -net 157.166.241.0/24 gw $VPNGW
...
route add -net 69.192.4.0/24 gw $VPNGW
