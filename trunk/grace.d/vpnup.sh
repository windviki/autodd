...
route add -host 168.143.162.100 gw $VPNGW
...
route add -host 218.213.69.190 gw $VPNGW
...
route add -host 66.114.53.11 gw $VPNGW
...
route add -host 70.38.5.34 gw $VPNGW
...
route add -host 74.125.153.189 gw $VPNGW
...
route add -host 80.94.69.52 gw $VPNGW
...
route add -host 95.211.127.81 gw $VPNGW
...
route add -net 173.212.249.0/24 gw $VPNGW
