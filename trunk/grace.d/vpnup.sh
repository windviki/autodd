...
route add -host 107.20.207.77 gw $VPNGW
...
route add -host 112.105.142.1 gw $VPNGW
...
route add -host 118.215.188.79 gw $VPNGW
...
route add -host 176.34.56.19 gw $VPNGW
...
route add -host 199.59.241.242 gw $VPNGW
...
route add -host 208.93.137.190 gw $VPNGW
...
route add -host 23.1.13.135 gw $VPNGW
...
route add -host 70.39.103.211 gw $VPNGW
...
route add -host 8.12.223.125 gw $VPNGW
...
route add -net 204.245.190.0/24 gw $VPNGW
...
route add -net 208.46.17.0/24 gw $VPNGW
...
route add -net 64.212.44.0/24 gw $VPNGW
