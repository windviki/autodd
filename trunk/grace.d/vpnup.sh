...
route add -host 119.245.139.73 gw $VPNGW
...
route add -host 125.56.181.50 gw $VPNGW
...
route add -host 173.212.197.195 gw $VPNGW
...
route add -host 174.36.20.142 gw $VPNGW
...
route add -host 184.73.171.204 gw $VPNGW
...
route add -host 188.5.4.96 gw $VPNGW
...
route add -host 198.78.200.126 gw $VPNGW
...
route add -host 199.93.63.126 gw $VPNGW
...
route add -host 212.58.244.68 gw $VPNGW
...
route add -host 219.87.174.12 gw $VPNGW
...
route add -host 46.51.247.76 gw $VPNGW
...
route add -host 50.19.83.240 gw $VPNGW
...
route add -host 61.92.115.57 gw $VPNGW
...
route add -host 69.171.228.11 gw $VPNGW
...
route add -host 69.43.161.187 gw $VPNGW
...
route add -host 69.6.27.100 gw $VPNGW
...
route add -host 70.29.37.215 gw $VPNGW
...
route add -host 72.167.51.137 gw $VPNGW
...
route add -host 8.12.218.126 gw $VPNGW
route add -host 8.17.172.71 gw $VPNGW
route add -host 8.18.200.7 gw $VPNGW
route add -host 8.23.224.110 gw $VPNGW
route add -host 8.26.198.254 gw $VPNGW
route add -host 8.26.207.126 gw $VPNGW
route add -host 8.27.233.126 gw $VPNGW
...
route add -net 67.129.144.0/24 gw $VPNGW
...
route add -net 87.245.192.0/24 gw $VPNGW
