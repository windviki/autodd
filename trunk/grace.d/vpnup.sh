...
route add -host 107.20.133.238 gw $VPNGW
route add -host 107.20.142.212 gw $VPNGW
route add -host 107.22.212.115 gw $VPNGW
route add -host 107.22.233.232 gw $VPNGW
route add -host 107.22.234.17 gw $VPNGW
route add -host 107.22.237.228 gw $VPNGW
...
route add -host 113.253.129.125 gw $VPNGW
...
route add -host 123.204.26.247 gw $VPNGW
...
route add -host 124.9.0.73 gw $VPNGW
...
route add -host 175.41.199.216 gw $VPNGW
...
route add -host 199.59.241.247 gw $VPNGW
...
route add -host 202.177.15.85 gw $VPNGW
...
route add -host 208.69.40.101 gw $VPNGW
...
route add -host 38.101.236.62 gw $VPNGW
...
route add -host 4.28.128.219 gw $VPNGW
...
route add -host 60.179.58.214 gw $VPNGW
...
route add -host 67.220.209.137 gw $VPNGW
...
route add -host 77.4.7.92 gw $VPNGW
...
route add -host 96.6.197.50 gw $VPNGW
route add -host 96.6.204.79 gw $VPNGW
...
route add -net 122.112.2.0/24 gw $VPNGW
...
route add -net 173.193.215.0/24 gw $VPNGW
route add -net 173.194.33.0/24 gw $VPNGW
...
route add -net 174.37.195.0/24 gw $VPNGW
...
route add -net 218.32.87.0/24 gw $VPNGW
...
route add -net 46.51.252.0/24 gw $VPNGW
...
route add -net 63.80.4.0/24 gw $VPNGW
