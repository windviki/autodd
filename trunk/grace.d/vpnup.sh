...
route add -host 174.129.213.209 gw $VPNGW
...
route add -host 176.34.27.107 gw $VPNGW
...
route add -host 184.105.178.92 gw $VPNGW
...
route add -host 184.29.213.50 gw $VPNGW
route add -host 184.30.252.79 gw $VPNGW
route add -host 184.51.37.135 gw $VPNGW
...
route add -host 189.163.17.5 gw $VPNGW
...
route add -host 199.59.148.10 gw $VPNGW
...
route add -host 37.61.54.158 gw $VPNGW
...
route add -host 50.19.86.72 gw $VPNGW
...
route add -host 72.246.201.50 gw $VPNGW
...
route add -net 173.223.232.0/24 gw $VPNGW
...
route add -net 206.57.116.0/24 gw $VPNGW
route add -net 207.138.126.0/24 gw $VPNGW
...
route add -net 63.85.36.0/24 gw $VPNGW
route add -net 63.97.123.0/24 gw $VPNGW
route add -net 63.97.127.0/24 gw $VPNGW
